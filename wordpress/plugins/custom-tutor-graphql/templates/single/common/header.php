<?php
/**
 * Common header template (LMS Tutor GraphQL override).
 *
 * Exit controls (X / mobile back) point to Astro return URL instead of course/kokpit.
 *
 * Based on Tutor LMS templates/single/common/header.php
 *
...
// Prefer Astro return URL from handoff; fall back to course permalink.
$exit_url = function_exists( 'custom_tutor_graphql_return_url' )
	? custom_tutor_graphql_return_url()
	: '';
if ( $exit_url === '' ) {
	$exit_url = (string) get_the_permalink( $course_id );
}
...
<div class="tutor-course-topic-single-header tutor-single-page-top-bar">
	...
	<a href="<?php echo esc_url( $exit_url ); ?>" class="tutor-iconic-btn tutor-d-flex tutor-d-xl-none" data-ctg-back="1" aria-label="<?php esc_attr_e( 'Wróć do konta', 'custom-tutor-graphql' ); ?>">
	...
	<div class="tutor-ml-auto tutor-align-center tutor-d-none tutor-d-xl-flex">
		...
		?>
		<a class="tutor-iconic-btn tutor-flex-shrink-0" href="<?php echo esc_url( $exit_url ); ?>" data-ctg-back="1" aria-label="<?php esc_attr_e( 'Wróć do konta', 'custom-tutor-graphql' ); ?>">
